        ...
        <div className="flex items-center justify-between">
          ...
          {showGenerateButton && onGenerate && (
            <button
              ...
              className="px-4 py-2 bg-[var(--nv-color-accent)] text-white rounded-lg hover:bg-[#114f88] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isGenerating ? (
                <>
